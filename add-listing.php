                        ...
                        <div class="listing-wrap">
                            <form method="post" enctype="multipart/form-data" id="my-form" action="">
                                ...
                                <div class="listing-title">
                                    <span class="ti-files" style = "color:#FF8C00;"></span>
...
<option value="<?php echo htmlentities($row->ID);?>"><?php echo htmlentities($row->Category);?></option>
 <?php } ?> 
                                ...
                                <!-- Add Location -->
                                <div class="listing-title">
                                    <span class="ti-location-pin" style = "color:#FF8C00;"></span>
                                ...
                                <!-- Add Gallery -->
                                <div class="listing-title">
                                    <span class="ti-gallery"style = "color:#FF8C00;"></span>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="btn-wrap btn-wrap2">
                                            <button type="submit" class="btn btn-primary" name="submit" id="submit"style = "background-color:#FF8C00;">SUBMIT LISTING</button>
                                        </div>
                                    </div>
                                </div>
                                <!--//End Opening Hours -->
